package com.hoadong.mytalk.frags.assist;
...
public class PermissionsFragment extends BottomSheetDialogFragment
    ...
    private void refreshState(View root) {
        ...
        root.findViewById(R.id.iv_state_permission_read).setVisibility(haveReadPerm(context) ? View.VISIBLE : View.GONE);

        root.findViewById(R.id.iv_state_permission_write).setVisibility(haveWritePerm(context) ? View.VISIBLE : View.GONE);

        root.findViewById(R.id.iv_state_permission_audio).setVisibility(haveRecordAudioPerm(context) ? View.VISIBLE : View.GONE);
